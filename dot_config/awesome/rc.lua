...
beautiful.init("/home/kevin/.config/awesome/themes/default/theme.lua")
...
vicious.register(thermalwidget, vicious.widgets.thermal, "| $1°C ", 5, "thermal_zone6")
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, ""        }, "q", function () awful.spawn("systemd_lock_screen") end,
    ...
    awful.key({}, "XF86AudioPlay", function () awful.spawn("sp play") end,
              {description = "Spotify: Play / Pause", group = "Spotify"}),
    awful.key({}, "XF86AudioNext", function () awful.spawn("sp next") end,
              {description =  "Spotify: Next song", group = "Spotify"}),
    awful.key({}, "XF86AudioPrev", function () awful.spawn("sp prev") end,
              {description = "Spotfy: Previous song", group = "Spotify"}),

    -- Backlight
    awful.key({}, "XF86MonBrightnessUp", function () awful.spawn("xbacklight -inc 15") end,
              {description = "Increase brightness", group = "Backlight"}),
    awful.key({}, "XF86MonBrightnessDown", function () awful.spawn("xbacklight -dec 15") end,
              {description = "Decrease brightness", group = "Backlight"}),

    -- Misc
    awful.key({ modkey, "Shift" }, "p", function () awful.spawn("copyq toggle") end,
              {description = "open copyq", group = "clipboard"}),
    awful.key({ }, "Print", function () awful.spawn("flameshot gui") end,
              {description = "Make a screenshot (relies on flameshot)", group = "clipboard"}),
    awful.key({ modkey }, ".", function () awful.spawn("rofi -modi emoji -show emoji") end,
              {description = "Open a popup to select emoji", group = "input"})
)
...
awful.rules.rules = {
    ...
    { rule = { name = "Age of Empires II: HD Edition" },
